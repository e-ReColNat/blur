...
python -c 'import sys; (print("Please update your Python version to 3.5 or later"); exit(1)) if sys.version_info.major < 3 and sys.version_info.minor < 5 else print("Python version checked OK")';
